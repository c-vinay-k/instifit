...
public class PushUps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back=findViewById(R.id.pushupsback);
        reps=findViewById(R.id.reps);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(com.example.instifit.Exercises.PushUps.this, Home.class));
            }
        });
        ...
        if(val < 20){
            reps.setText("No.of reps per set (as per your BMI) = 10");
        }else if(val < 24){
            reps.setText("No.of reps per set (as per your BMI) = 15");
        }else{
